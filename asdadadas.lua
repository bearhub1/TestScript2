...
function royxui:royxstart(text,logo)
	...
	function royxui:Notification(text,text2,delays,logo)
		...
		imagenoti.Image = "http://www.roblox.com/asset/?id="..tostring(10578996843)
        imagenoti.ImageColor3 = Color3.fromRGB(85, 170, 255)
	...
	LogoTop.Image = "http://www.roblox.com/asset/?id="..tostring(10578996843)
	LogoTop.ScaleType = Enum.ScaleType.Crop
    LogoTop.ImageColor3 = Color3.fromRGB(85, 170, 255)
	...
	function royxtabui:royxtab(text,logo)
		...
		LogoBar.Image = "http://www.roblox.com/asset/?id="..tostring(10578996843)
		LogoBar.ScaleType = Enum.ScaleType.Crop
        LogoBar.ImageColor3 = Color3.fromRGB(85, 170, 255)
		...
		function royxpageui:royxpage(text)
			...
			function royxfunction:Toggle(text,logo,config,callback)
				...
				LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(10578996843)
                LogoToggle.ImageColor3 = Color3.fromRGB(85, 170, 255)
			...
			function royxfunction:MultiDropdown(text,use,option,callback)
				...
				DropArbt_listimage.Image = "http://www.roblox.com/asset/?id=3926305904"
